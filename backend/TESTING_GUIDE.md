...
- ✅ AUTOMATIC1111 corriendo (opcional, puede fallar gracefully)
- ✅ Celery worker activo
- ✅ Redis corriendo

#### Proceso
1. **Crear Template** (si no existe)
2. **Crear Video Request** via API
3. **Encolar Generación** con `POST /videos/{id}/generate`
4. **Monitorear Celery Worker**:
```
...
```json
{"timestamp":"2025-11-23T18:00:00","level":"INFO","message":"Video generation started"}
```
...
### Funcionalidad
- [ ] Script generation con Gemini funciona
- [ ] Image generation (o fallback) funciona
- [ ] TTS genera audio correctamente
- [ ] Video assembly completa sin errores
...
- Para testing completo, instala A1111
...
- ✅ **API Response Time**: < 100ms para endpoints de lectura
- ✅ **Script Generation**: 2-5 segundos con Gemini
- ✅ **Image Generation**: 10-30 segundos por imagen (con A1111)
- ✅ **Video Assembly**: 30-60 segundos para video de 15s
- ✅ **Cache Hit Rate**: > 50% en segundo uso
- ✅ **Test Pass Rate**: 100% (con configuración completa)
...
1. **Personalizar Configuración**
   ...
   - Configurar reglas de scheduling
